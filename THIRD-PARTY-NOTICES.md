...
The visual tokens, paper-texture treatment, font setup, and static Next.js configuration draw on the Geometric Signatures paper companion by Dimitris Ntounis, licensed under MIT. The original notice is preserved in [public/licenses/reused-code-MIT.txt](public/licenses/reused-code-MIT.txt) and ships with the static export.
